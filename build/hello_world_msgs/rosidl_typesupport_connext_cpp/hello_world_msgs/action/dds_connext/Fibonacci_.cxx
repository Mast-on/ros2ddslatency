...
namespace hello_world_msgs {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_Goal_TYPENAME = "hello_world_msgs::action::dds_::Fibonacci_Goal_";
            ...
            DDS_TypeCode* Fibonacci_Goal__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"hello_world_msgs::action::dds_::Fibonacci_Goal_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Fibonacci_Goal__initialize(
                ...
                return hello_world_msgs::action::dds_::Fibonacci_Goal__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_Goal_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return hello_world_msgs::action::dds_::Fibonacci_Goal__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_Goal_* sample)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Goal__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_Goal_* sample,RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Goal__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params hello_world_msgs::action::dds_::Fibonacci_Goal__initialize_w_params

            #define T_finalize_w_params   hello_world_msgs::action::dds_::Fibonacci_Goal__finalize_w_params
            #define T_copy       hello_world_msgs::action::dds_::Fibonacci_Goal__copy
...
namespace hello_world_msgs {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_SendGoal_Request_TYPENAME = "hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request_";
            ...
            DDS_TypeCode* Fibonacci_SendGoal_Request__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                Fibonacci_SendGoal_Request__g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)hello_world_msgs::action::dds_::Fibonacci_Goal__get_typecode();
            ...
            RTIBool Fibonacci_SendGoal_Request__initialize(
                ...
                return hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_SendGoal_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_SendGoal_Request_* sample, const struct DDS_TypeAllocationParams_t * allocParams)
            {
                ...
                if (!hello_world_msgs::action::dds_::Fibonacci_Goal__initialize_w_params(&sample->goal_,
                allocParams)) {
                    return RTI_FALSE;
                }
                return RTI_TRUE;
                ...
                Fibonacci_SendGoal_Request_* sample)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_SendGoal_Request_* sample,RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request__finalize_w_params(
                    sample,&deallocParams);
            }
                ...
                Fibonacci_SendGoal_Request_* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Goal__finalize_w_params(&sample->goal_,deallocParams);
                ...
                Fibonacci_SendGoal_Request_* sample, RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Goal__finalize_optional_members(&sample->goal_, deallocParams->delete_pointers);
            }
                ...
                const Fibonacci_SendGoal_Request_* src)
            {
                try {
                    ...
                    if (!hello_world_msgs::action::dds_::Fibonacci_Goal__copy(
                        &dst->goal_,(const hello_world_msgs::action::dds_::Fibonacci_Goal_*)&src->goal_)) {
                        return RTI_FALSE;
                    } 
            ...
            */
            ...
            #define T_initialize_w_params hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request__initialize_w_params

            #define T_finalize_w_params   hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request__finalize_w_params
            #define T_copy       hello_world_msgs::action::dds_::Fibonacci_SendGoal_Request__copy
...
namespace hello_world_msgs {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_SendGoal_Response_TYPENAME = "hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response_";
            ...
            DDS_TypeCode* Fibonacci_SendGoal_Response__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Fibonacci_SendGoal_Response__initialize(
                ...
                return hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_SendGoal_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_SendGoal_Response_* sample)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_SendGoal_Response_* sample,RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response__initialize_w_params

            #define T_finalize_w_params   hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response__finalize_w_params
            #define T_copy       hello_world_msgs::action::dds_::Fibonacci_SendGoal_Response__copy
...
namespace hello_world_msgs {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_Result_TYPENAME = "hello_world_msgs::action::dds_::Fibonacci_Result_";
            ...
            DDS_TypeCode* Fibonacci_Result__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"hello_world_msgs::action::dds_::Fibonacci_Result_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Fibonacci_Result__initialize(
                ...
                return hello_world_msgs::action::dds_::Fibonacci_Result__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_Result_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return hello_world_msgs::action::dds_::Fibonacci_Result__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_Result_* sample)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Result__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_Result_* sample,RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Result__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params hello_world_msgs::action::dds_::Fibonacci_Result__initialize_w_params

            #define T_finalize_w_params   hello_world_msgs::action::dds_::Fibonacci_Result__finalize_w_params
            #define T_copy       hello_world_msgs::action::dds_::Fibonacci_Result__copy
...
namespace hello_world_msgs {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_GetResult_Request_TYPENAME = "hello_world_msgs::action::dds_::Fibonacci_GetResult_Request_";
            ...
            DDS_TypeCode* Fibonacci_GetResult_Request__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"hello_world_msgs::action::dds_::Fibonacci_GetResult_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Fibonacci_GetResult_Request__initialize(
                ...
                return hello_world_msgs::action::dds_::Fibonacci_GetResult_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_GetResult_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return hello_world_msgs::action::dds_::Fibonacci_GetResult_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_GetResult_Request_* sample)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_GetResult_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_GetResult_Request_* sample,RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_GetResult_Request__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params hello_world_msgs::action::dds_::Fibonacci_GetResult_Request__initialize_w_params

            #define T_finalize_w_params   hello_world_msgs::action::dds_::Fibonacci_GetResult_Request__finalize_w_params
            #define T_copy       hello_world_msgs::action::dds_::Fibonacci_GetResult_Request__copy
...
namespace hello_world_msgs {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_GetResult_Response_TYPENAME = "hello_world_msgs::action::dds_::Fibonacci_GetResult_Response_";
            ...
            DDS_TypeCode* Fibonacci_GetResult_Response__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"hello_world_msgs::action::dds_::Fibonacci_GetResult_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                Fibonacci_GetResult_Response__g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)hello_world_msgs::action::dds_::Fibonacci_Result__get_typecode();
            ...
            RTIBool Fibonacci_GetResult_Response__initialize(
                ...
                return hello_world_msgs::action::dds_::Fibonacci_GetResult_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_GetResult_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return hello_world_msgs::action::dds_::Fibonacci_GetResult_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_GetResult_Response_* sample, const struct DDS_TypeAllocationParams_t * allocParams)
            {
                ...
                if (!hello_world_msgs::action::dds_::Fibonacci_Result__initialize_w_params(&sample->result_,
                allocParams)) {
                    return RTI_FALSE;
                }
                return RTI_TRUE;
                ...
                Fibonacci_GetResult_Response_* sample)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_GetResult_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_GetResult_Response_* sample,RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_GetResult_Response__finalize_w_params(
                    sample,&deallocParams);
            }
                ...
                Fibonacci_GetResult_Response_* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Result__finalize_w_params(&sample->result_,deallocParams);
                ...
                Fibonacci_GetResult_Response_* sample, RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Result__finalize_optional_members(&sample->result_, deallocParams->delete_pointers);
            }
                ...
                const Fibonacci_GetResult_Response_* src)
            {
                try {
                    ...
                    if (!hello_world_msgs::action::dds_::Fibonacci_Result__copy(
                        &dst->result_,(const hello_world_msgs::action::dds_::Fibonacci_Result_*)&src->result_)) {
                        return RTI_FALSE;
                    } 
            ...
            */
            ...
            #define T_initialize_w_params hello_world_msgs::action::dds_::Fibonacci_GetResult_Response__initialize_w_params

            #define T_finalize_w_params   hello_world_msgs::action::dds_::Fibonacci_GetResult_Response__finalize_w_params
            #define T_copy       hello_world_msgs::action::dds_::Fibonacci_GetResult_Response__copy
...
namespace hello_world_msgs {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_Feedback_TYPENAME = "hello_world_msgs::action::dds_::Fibonacci_Feedback_";
            ...
            DDS_TypeCode* Fibonacci_Feedback__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"hello_world_msgs::action::dds_::Fibonacci_Feedback_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Fibonacci_Feedback__initialize(
                ...
                return hello_world_msgs::action::dds_::Fibonacci_Feedback__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_Feedback_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return hello_world_msgs::action::dds_::Fibonacci_Feedback__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_Feedback_* sample)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Feedback__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_Feedback_* sample,RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Feedback__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params hello_world_msgs::action::dds_::Fibonacci_Feedback__initialize_w_params

            #define T_finalize_w_params   hello_world_msgs::action::dds_::Fibonacci_Feedback__finalize_w_params
            #define T_copy       hello_world_msgs::action::dds_::Fibonacci_Feedback__copy
...
namespace hello_world_msgs {
    namespace action {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Fibonacci_FeedbackMessage_TYPENAME = "hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage_";
            ...
            DDS_TypeCode* Fibonacci_FeedbackMessage__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                Fibonacci_FeedbackMessage__g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)hello_world_msgs::action::dds_::Fibonacci_Feedback__get_typecode();
            ...
            RTIBool Fibonacci_FeedbackMessage__initialize(
                ...
                return hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Fibonacci_FeedbackMessage_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage__initialize_w_params(
                    sample,&allocParams);
                ...
                Fibonacci_FeedbackMessage_* sample, const struct DDS_TypeAllocationParams_t * allocParams)
            {
                ...
                if (!hello_world_msgs::action::dds_::Fibonacci_Feedback__initialize_w_params(&sample->feedback_,
                allocParams)) {
                    return RTI_FALSE;
                }
                return RTI_TRUE;
                ...
                Fibonacci_FeedbackMessage_* sample)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Fibonacci_FeedbackMessage_* sample,RTIBool deletePointers)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage__finalize_w_params(
                    sample,&deallocParams);
            }
                ...
                Fibonacci_FeedbackMessage_* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
            {
                ...
                hello_world_msgs::action::dds_::Fibonacci_Feedback__finalize_w_params(&sample->feedback_,deallocParams);
                ...
                Fibonacci_FeedbackMessage_* sample, RTIBool deletePointers)
            {
                ...
                unique_identifier_msgs::msg::dds_::UUID__finalize_optional_members(&sample->goal_id_, deallocParams->delete_pointers);
                hello_world_msgs::action::dds_::Fibonacci_Feedback__finalize_optional_members(&sample->feedback_, deallocParams->delete_pointers);
            }
                ...
                const Fibonacci_FeedbackMessage_* src)
            {
                try {
                    ...
                    if (!hello_world_msgs::action::dds_::Fibonacci_Feedback__copy(
                        &dst->feedback_,(const hello_world_msgs::action::dds_::Fibonacci_Feedback_*)&src->feedback_)) {
                        return RTI_FALSE;
                    } 
            ...
            */
            ...
            #define T_initialize_w_params hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage__initialize_w_params

            #define T_finalize_w_params   hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage__finalize_w_params
            #define T_copy       hello_world_msgs::action::dds_::Fibonacci_FeedbackMessage__copy
