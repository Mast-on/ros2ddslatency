...
#include "hello_world_msgs/srv/set_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hello_world_msgs
max_serialized_size_SetMessage_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::srv::SetMessage_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hello_world_msgs::srv::SetMessage_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetMessage_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hello_world_msgs::srv::SetMessage_Request *>(
...
{
  return max_serialized_size_SetMessage_Request(full_bounded, 0);
}
...
{
  return &hello_world_msgs::srv::typesupport_fastrtps_cpp::_SetMessage_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, srv, SetMessage_Request)() {
  return &hello_world_msgs::srv::typesupport_fastrtps_cpp::_SetMessage_Request__handle;
}
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hello_world_msgs
max_serialized_size_SetMessage_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::srv::SetMessage_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hello_world_msgs::srv::SetMessage_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetMessage_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hello_world_msgs::srv::SetMessage_Response *>(
...
{
  return max_serialized_size_SetMessage_Response(full_bounded, 0);
}
...
{
  return &hello_world_msgs::srv::typesupport_fastrtps_cpp::_SetMessage_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, srv, SetMessage_Response)() {
  return &hello_world_msgs::srv::typesupport_fastrtps_cpp::_SetMessage_Response__handle;
}
...
{
  return &hello_world_msgs::srv::typesupport_fastrtps_cpp::_SetMessage__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, srv, SetMessage)() {
  return &hello_world_msgs::srv::typesupport_fastrtps_cpp::_SetMessage__handle;
}
