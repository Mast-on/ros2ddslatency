...
#include "hello_world_msgs/action/fibonacci__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hello_world_msgs::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_Goal)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hello_world_msgs::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_Result)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hello_world_msgs::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_Feedback)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  hello_world_msgs::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
  ...
  hello_world_msgs::action::Fibonacci_SendGoal_Request & ros_message)
{
  ...
  // Member: goal
  hello_world_msgs::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    hello_world_msgs::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        hello_world_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Goal(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hello_world_msgs::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_SendGoal_Request)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hello_world_msgs::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_SendGoal_Response)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_SendGoal)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hello_world_msgs::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_GetResult_Request)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        hello_world_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Result(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hello_world_msgs::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_GetResult_Response)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_GetResult)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        hello_world_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Feedback(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const hello_world_msgs::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hello_world_msgs::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hello_world_msgs, action, Fibonacci_FeedbackMessage)() {
  return &hello_world_msgs::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
